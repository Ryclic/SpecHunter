...
work, \sh{} contributes the agentic control loop and a fail-closed evidence
discipline: an untrusted model may steer the search, but no claim survives that a
deterministic oracle and a recomputable seal do not independently support.
