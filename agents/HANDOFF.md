...
results. Its handoff section was removed during cleanup; it is still in git history.
...
- The old paper (`paper/spechunter.tex`/`.typ`/`spechunter_micro2026.pdf`, now deleted) cited
  those values. It
